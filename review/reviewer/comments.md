...
> 筆記：
> * 重寫程式碼優先於單純的文字解釋: 如果審查者不理解某段程式碼，最好的解決方案通常是讓開發人員重寫該段程式碼，使其更清晰易懂。
> * 程式碼內的註解： 在某些情況下，在程式碼中添加註解也是可接受的回應，但前提是這些註解不是用來解釋過於複雜的程式碼。
> * 避免僅在審查工具中寫解釋: 僅在程式碼審查工具中寫下的解釋，對於未來的程式碼閱讀者來說沒有幫助。 僅在少數情況下可接受，例如當審查者對該領域不太熟悉，而開發人員解釋了正常程式碼閱讀者本應已知的事情。
> 
> 解釋:
> * 程式碼的可讀性對於軟體維護和團隊合作至關重要。僅在審查工具中留下解釋，無法幫助其他開發人員理解程式碼，也無法改善程式碼本身的品質。
> * 重寫程式碼可以迫使開發人員重新思考程式碼的設計和實現，使其更清晰、更簡潔、更易於理解。
> * 合適的註解可以幫助解釋程式碼的意圖和設計決策，但過多的註解反而會增加閱讀負擔。
> 
> 總結:
> * 個段落強調了在程式碼審查中，鼓勵開發人員通過重寫程式碼來提高可讀性，而不是僅僅依靠文字解釋。
